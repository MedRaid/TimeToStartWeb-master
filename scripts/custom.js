$(window).load(function() { 
	...
	$("#preloader").delay(20).fadeOut("fast"); // will fade out the white DIV that covers the website.
});
...
$( document ).ready(function() {
    ...
    $('.switch-1').click(function(){
        ...
        var SECRET_KEY = 'B39B243B-1A95-530D-FF7B-F20388A57800';
        var VERSION = 'v1';
	   ...
	   var rec=  localStorage.getItem("markeremail");
		alert(rec);
	    alert("entreeeeeeeee");
	    var contactObject = new Requests( {
	        receiver: rec,
	       sender: emails,
	       appoved: "0",
	       //sendername: localStorage.getItem("names"),
	       sendername:  names,
	     pic: pics,
	     statut:"off",
	          // day: date,
	    ...
	    Backendless.Persistence.of( Requests ).save( contactObject, new Backendless.Async( objectSaved, gotError ) );
